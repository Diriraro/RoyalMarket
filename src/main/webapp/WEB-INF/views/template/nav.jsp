	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<c:if test="${not empty member}">
				<li><a
					href="${pageContext.request.contextPath}/payment/sell_History"><span
						class="glyphicon glyphicon-user"></span> 판매내역</a></li>
				<li><a
					href="${pageContext.request.contextPath}/payment/buy_History"><span
						class="glyphicon glyphicon-user"></span> 구매내역</a></li>
				<li><a
					href="${pageContext.request.contextPath}/shop/myshop?mem_storeNum=${member.mem_storeNum}"><span
						class="glyphicon glyphicon-user"></span> 내상점</a></li>
				<li><a
