	...
	<div style="height: 88px;">
		...
		<div style="width: 1024px; margin-left: 440px;">
			...
			<div style="width: 1024px;">
				...
				<c:if
					test="${empty list and ( param.kind eq 'sp'or param.kind eq 'sk'or param.kind eq 'st')}">
					<br>
					<br>
					<br>
					<br>
					...
					<font style="font-size: 20px; font-weight: 600">에 대한 검색결과가
						없습니다</font>
					<hr>
...
- 유해/금지어가 아닌지 확인해주세요 
			...
			<c:forEach items="${list}" var="vo" varStatus="i">
				<div style="float: left; margin-left: 9px; margin-bottom: 129px;">
					...
					<div class="qqq" title="${vo.sell_num}"
						...
						<div
							style="width: 194px; background-color: white; border: 1px solid #e5e5e5">
			...
			<c:if
				test="${not empty list and (param.kind eq 'sp'or param.kind eq 'sk'or param.kind eq 'st')}">
	...
	<div
		style="background-color: white; display: inline-block; height: 730px;"></div>
