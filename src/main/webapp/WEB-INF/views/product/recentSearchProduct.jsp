	...
	<c:forEach items="${recentSearch}" var="vo" varStatus="i" end="4">
		<div class="recentSearchContainer">
			<img
				...
				alt="상품 이미지"
				src="${pageContext.request.contextPath}/upload/product/${file[i.index]}" style="cursor:pointer;">
			<p style="text-align: left; padding: 0px 20px">상품명 :
				${vo.sell_product}</p>
			<p style="text-align: left; padding: 0px 20px">상품 가격
				:${vo.sell_price}</p>
		</div>
		<br>
	</c:forEach>
