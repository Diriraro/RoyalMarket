  ...
  import com.iu.s1.interceptor.AdminInterceptor; import
  com.iu.s1.interceptor.BuyerPageInterceptor; import
  com.iu.s1.interceptor.ProductInterceptor; import
  com.iu.s1.interceptor.SellerPageInterceptor;
  
  
  @Configuration public class InterceptorConfig implements WebMvcConfigurer {
  
  @Autowired private SellerPageInterceptor sellerPageInterceptor;
  
  @Autowired private BuyerPageInterceptor buyerPageInterceptor;
  
  @Autowired private ProductInterceptor productInterceptor;
  ...
  registry.addInterceptor(productInterceptor) .addPathPatterns("/product/*")
  .addPathPatterns("/shop/*") .addPathPatterns("/payment/*")
  ...
  //적용할 Interceptor 등록 //registry.addInterceptor(productQnaInterceptor)
  //Interceptor를 사용할 URL 등록
  
  //Interceptro에서 제외할 URL 등록 //.excludePathPatterns("");
